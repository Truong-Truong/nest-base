...
var users_dto_1 = require("./dto/users.dto");
var UsersController = function () {
    ...
    var UsersController = _classThis = /** @class */ (function () {
        ...
        function UsersController_1(usersService, fbConfig, fbConfigEdited) {
            this.usersService = (__runInitializers(this, _instanceExtraInitializers), usersService);
            this.fbConfig = fbConfig;
            this.fbConfigEdited = fbConfigEdited;
        ...
        UsersController_1.prototype.createUser = function (user) {
            console.log('user from fe', user);
            // const userClear = this.moduleRef.get(UsersService).createUser(user);
            var result = users_dto_1.UsersDto.plainToInstance(this.usersService.createUser(user));
    ...
    (function () {
        ...
        _createUser_decorators = [(0, common_1.UsePipes)(new common_1.ValidationPipe()), (0, common_1.Post)()];
